    ...
    return (
        <div className='flex flex-col gap-4 px-2 pt-5'>
            ...
            <div className='flex flex-col items-start'>
              ...
              <span>Gadegade nr</span></div>

            <p className='pb-2 text-left text-black/60 font-Montserrat'>Bekræft venligst dato og tid</p>
            <label htmlFor='date' className='pb-2 text-left text-black/60 font-Montserrat' >Dato
